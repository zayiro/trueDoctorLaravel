...
return [
    ...
    'backup' => [
        ...
        'source' => [
            ...
            'mysql' => [
                ...
                'dump' => [
                    'dump_binary_path' => '/usr/bin/', // Ubicación estándar en EC2 AL2023
                    'use_single_transaction' => true,  // Evita bloquear la DB mientras se hace el backup
                ],
            ],
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => 'ocampotecnologo@gmail.com',

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'hello@opendoctor.online'),
