    ...
    <div class="max-w-5xl mx-auto py-12 px-4 mt-6">
        ...
        <div class="max-w-4xl mx-auto space-y-6">            
            ...
            <div class="flex justify-between items-center print:hidden bg-white p-4 border border-slate-200 rounded-2xl shadow-sm">
                ...
                <button onclick="window.print()" class="px-4 py-2.5 bg-slate-900 hover:bg-slate-950 text-xs text-white font-bold rounded-xl shadow-md active:scale-95 transition-all flex items-center gap-1.5">
