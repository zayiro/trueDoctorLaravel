        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
            ...
            <form action="{{ route('doctor.appointments.index') }}" method="GET" class="flex items-center gap-2">
                <input type="date" name="date" value="{{ $date }}" 
                       class="rounded-xl border-gray-300 text-sm focus:ring-blue-500">
        ...
        <div class="bg-white shadow-xl rounded-3xl overflow-hidden border border-gray-100">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center text-gray-400 italic">No hay citas para esta fecha.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
