...
@section('title', 'Configurar Horarios')
@section('header', 'Horarios de Atención')
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-8 flex items-center justify-between">
        ...
        <a href="{{ route('doctor.addresses.index') }}" class="text-sm font-bold text-blue-600 hover:text-blue-800 transition">
            &larr; Volver a Sedes
        </a>
    </div>
...
<style>
    ...
    .fc-timegrid-slot-label-cushion { color: #94a3b8; font-size: 0.7rem; font-weight: 700; }
