...
<x-admin-layout :breadcrumbs="$breadcrumbs">
    @if (session('success'))
    <div id="success-alert" class="mb-6 flex items-center p-4 text-green-800 rounded-2xl bg-green-50 border border-green-100 shadow-sm transition-opacity duration-500" role="alert">
