    ...
    <div class="max-w-4xl mx-auto py-12 px-4 mt-6">
        ...
        <div class="bg-white rounded-[2.5rem] shadow-xl overflow-hidden border border-slate-100 relative">
            ...
            <div class="p-8 space-y-5">
                ...
                <!-- TABLA DE PRECIOS SIMPLES SIN PROMO (por ahora) -->
                    ...
                    <div class="mt-8 border-t border-slate-50 pt-6">
                        ...
                        @else
                            ...
                            <form action="{{ route('appointments.success', $appointment) }}" method="GET">                                
                                <button type="submit" class="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-4 rounded-2xl font-black shadow-lg shadow-indigo-100 transition-all text-sm uppercase tracking-wider focus:outline-none focus:ring-2 focus:ring-indigo-500/20 flex items-center justify-center gap-2">
