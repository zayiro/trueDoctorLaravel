...
<div class="max-w-7xl mx-auto my-8 bg-white border border-slate-200 rounded-2xl shadow-sm p-6 sm:p-8">
    ...
    @if($status === 'pending_validation')
        <div class="text-center py-8">
            <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-white-50 text-amber-600 mb-4 ring-4 ring-amber-100">
<div role="status">
    ...
    @else
        ...
        <form action="{{ route('partner.verify.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <!-- Botón de Envío -->
            <button type="submit" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-xl border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition shadow-sm">
