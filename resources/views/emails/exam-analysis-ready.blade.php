    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);">
        ...
        <tr>
            <td style="padding: 32px;">
                <p style="margin: 0 0 16px 0; font-size: 16px; font-weight: 600; color: #0f172a;">Hola,</p>

                <p style="margin: 0 0 24px 0; font-size: 14px; line-height: 22px; color: #64748b;">
                    Queremos informarte que el análisis de tu examen de
                    <strong>"{{ $analysis->ai_response['nombre_examen'] ?? 'Laboratorio' }}"</strong>
                    ha sido procesado de forma exitosa tras confirmar tu pago.
                </p>
                ...
                <p style="margin: 16px 0 0 0; font-size: 11px; line-height: 16px; color: #94a3b8; text-align: center;">
                    Este enlace es personal e intransferible. No lo compartas por redes sociales ni canales públicos.
                </p>
            </td>
        </tr>

        @if(! empty($analysis->ai_response['especialidad_slug']))
        <tr>
            <td>
                    ...
                    <tr>
                        <td style="padding: 24px; text-align: center;">
                            ...
                            <p style="margin: 0 0 20px 0; font-size: 13px; line-height: 18px; color: #94a3b8;">
                                La IA sugiere consultar con el área de
                                <strong style="color: #818cf8; text-transform: capitalize;">{{ str_replace('-', ' ', $analysis->ai_response['especialidad_slug']) }}</strong>
                                para dar un seguimiento profesional a tus métricas.
                            </p>
                            <a href="{{ route('search', ['specialty' => $analysis->ai_response['especialidad_slug']]) }}" target="_blank" style="background-color: #ffffff; color: #0f172a; padding: 12px 24px; font-size: 13px; font-weight: 700; text-decoration: none; border-radius: 8px; display: inline-block;">
                                Encontrar Especialista en OpenDoctor.online
                            </a>
                        </td>
                    </tr>
                </table>
