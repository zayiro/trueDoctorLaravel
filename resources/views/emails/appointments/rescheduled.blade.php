...
<head>
    ...
    <title>Reprogramación de Cita - opendoctor.online</title>    
</head>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border: 1px solid #e2e8f0; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);">
                    <tr>
                        <td style="padding: 32px 32px 24px 32px; text-align: center; border-bottom: 1px solid #f1f5f9;">
                            ...
                            <div style="display: inline-block; background-color: #fef3c7; color: #d97706; font-size: 12px; font-weight: 700; padding: 6px 14px; border-radius: 9999px; text-transform: uppercase;">
                                ⚠ Cita Reprogramada
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 32px 32px 24px 32px;">
                            ...
                            <p style="margin: 0; font-size: 15px; color: #475569; line-height: 1.6;">Te informamos que tu cita médica ha sido reprogramada por el profesional médico. A continuación, encuentras la actualización de tu agenda:</p>
                        </td>
                    </tr>
                    <tr>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td width="50%" style="vertical-align: top; padding-right: 10px;">
                                                    <span style="display: block; font-size: 11px; text-transform: uppercase; color: #ef4444; font-weight: 700;">Horario Anterior</span>
                                                    <span style="font-size: 14px; color: #94a3b8; font-weight: 500; text-decoration: line-through;">{{ $previousDateTime }}</span>
                                                </td>
                                                <td width="50%" style="vertical-align: top; padding-left: 10px; border-left: 1px solid #e2e8f0;">
                                                    <span style="display: block; font-size: 11px; text-transform: uppercase; color: #16a34a; font-weight: 700;">Nuevo Horario</span>
                                                    <span style="font-size: 15px; color: #16a34a; font-weight: 700;">
                                                        {{ \Carbon\Carbon::parse($appointment->date)->translatedFormat('d \d\e F, Y') }} <br>
                                        ...
                                        <div style="font-size: 14px; color: #334155;">
                                            @if($appointment->service->type === 'virtual')
                                                ...
                                                <div style="margin-top: 6px;">
                                                    <a href="{{ route('appointments.room', ['appointment' => $appointment->id]) }}" style="display: inline-block; background-color: #2563eb; color: #ffffff; text-decoration: none; font-size: 13px; font-weight: 600; padding: 8px 16px; border-radius: 8px;">Ingresar a la videoconsulta</a>
                                                </div>
                                            @else
                    ...
                    <tr>
                        <td style="padding: 0 32px 32px 32px; text-align: center;">
                            <p style="margin: 0 0 16px 0; font-size: 14px; color: #64748b;">¿Te genera algún conflicto este nuevo horario?</p>
                            <a href="{{ url('/dashboard') }}" style="color: #2563eb; border: 1px solid #cbd5e1; text-decoration: none; font-size: 14px; font-weight: 600; padding: 10px 20px; border-radius: 10px; display: inline-block;">Gestionar mi cita</a>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 24px 32px; background-color: #fffbeb; border-top: 1px solid #fef3c7; text-align: left;">
                            <p style="margin: 0; font-size: 13px; color: #b45309; line-height: 1.5;"><strong>Importante:</strong> Los enlaces de acceso a telemedicina y las asignaciones de salas físicas han sido actualizadas automáticamente para cumplir el nuevo horario fijado.</p>
                        </td>
                    </tr>
                </table>
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; text-align: center; margin-top: 24px;">
                    <tr>
                        <td style="padding: 0 20px; color: #94a3b8; font-size: 12px; line-height: 1.6;">
                            ...
                            <p style="margin: 0; font-size: 11px; color: #cbd5e1;">© 2026 opendoctor.online. <br><a href="https://opendoctor.online" style="color: #94a3b8; text-decoration: none;">Privacidad</a> | <a href="https://opendoctor.online" style="color: #94a3b8; text-decoration: none;">Términos</a></p>
                        </td>
                    </tr>
                </table>
            </td>
