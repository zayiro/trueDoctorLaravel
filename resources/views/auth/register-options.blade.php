    ...
    <div class="min-h-screen bg-slate-50 flex items-center justify-center py-12 px-6">
        <div class="max-w-5xl w-full">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <!-- Opción: Especialista -->
                <a href="{{ route('doctor.register') }}" class="group bg-white p-8 rounded-3xl shadow-sm border-2 border-transparent hover:border-blue-500 hover:shadow-xl transition-all duration-300 text-center">
