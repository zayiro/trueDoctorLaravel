        ...
        <div>
            ...
            <form action="{{ route('clinic.register.store') }}" method="POST" class="space-y-4" x-data="{ showPass: false, showConfirm: false, loading: false }" @submit="loading = true">
                ...
                <div>
                    ...
                    <x-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="razon social del centro medico" placeholder="Nombre del Centro Médico" />
                </div>                

                <div class="mt-4">
                    <x-label for="email" value="{{ __('Email') }}" />
                    <x-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autocomplete="medicalcenter@example.com" placeholder="medicalcenter@example.com" />
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="flex mt-1 rounded-xl shadow-sm border border-slate-200 bg-white focus-within:ring-2 focus-within:ring-blue-500 overflow-hidden">
                        ...
                        <select name="country_code" id="country_code" required 
                            class="bg-slate-50 text-slate-700 text-sm border-0 border-r border-slate-200 rounded-l-xl focus:ring-0 px-5 cursor-pointer px-8">
