...
class AppointmentRescheduledNotification extends Notification
{
    ...
    protected $actor; // Quién hizo el cambio ('paciente' o 'medico')
    ...
    // Definimos que se guarde en la base de datos (puedes añadir 'mail' aquí luego)
    public function via(object $notifiable): array
    {
        return ['database'];
    }

    // Estructura del JSON que se guardará en la tabla notifications
